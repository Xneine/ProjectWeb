            ...
            <Form class="text-white">
                ...
                <div class="row justify-content-center mb-3">
                    ...
                    <span class="d-none d-md-inline">
                        ...
                        <input type="text" namespace = "Fullname" id = "fullName" placeholder="Full Name" class="text-white" id = "name" required>
                    ...
                    <div class="col-8 col-md  my-2  my-md-0 border rounded-pill p-3 act ">
                        ...
                        <input type="text" namespace = "Username" id = "Username" placeholder="Username" class="text-white" id = "user" required>
                    ...
                    <div class="row justify-content-center  mb-3">
                        ...
                        <div class="col-8 col-md my-2 my-md-0 border rounded-pill p-3 act ">
                            ...
                            <input type="password" namespace = "Password" id = "Password" placeholder="Password" class="text-white" id="pass" required>
                        </div>
                        <div class="col-8 col-md my-2 my-md-0 border rounded-pill p-3 act ">
                            <div  class="d-md-inline d-none">
                                <span>
                            ...
                            <input type="password" namespace = "Password" id = "confirm" placeholder="Confirm Password" class="text-white" id="confirm" required>
                        </div>
                ...
                <!-- buat email bek phone -->
                    ...
                    <div class="col-md col-8 my-2 my-md-0 border rounded-pill p-3 act ">
                        ...
                        <input type="email" namespace = "email" id = "Email" placeholder="Email" class="text-white" id="mail" required>
                    ...
                    <span class="d-none d-md-inline-block">
                        ...
                        <input type="phone" namespace = "phone" id = "phone" placeholder="Phone" class="text-white" id="phone" required>
                    ...
                    <label for="birth">Date Of Birth</label>
                        ...
                        <input type="date" id="birth" value="2023-12-12" class="text-white">
                        </div>
                    ...
                    <label for="address">Address</label>
                       ...
                       <input type="textarea" id="address" class="text-white">
                        </div>
