    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="container col-9">
                <h1 class="text-center mt-3">HISTORY STOK MASUK</h1>

                <div class="card mt-3">
                    <div class="card-header bg-primary text-white">
                        Data History Stok Masuk
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            $tampil = mysqli_query($conn, "SELECT * FROM stokmasuk ORDER BY id_sm DESC LIMIT $start, $limit");
                            ...
                            <?php
                            $result_count = mysqli_query($conn, "SELECT COUNT(id_sm) AS total FROM stokmasuk");
                            ...
                            for ($i = 1; $i <= $total_pages; $i++) {
                                echo "<li class='page-item'><a class='page-link' href='sm_history.php?page=$i'>$i</a></li>";
                            }
                            echo "</ul>";
                            ?>
                        </table>
                ...
                <div class="modal fade" id="dateModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="sm_history_date.php">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary" name="bsm">Pilih</button>
                                </div>
                            </form>
                        </div>
                    </div>
