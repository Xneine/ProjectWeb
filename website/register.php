            ...
            <Form class="text-white" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
                ...
                <div class="row justify-content-center  mb-3">
                    ...
                    <div class="col-8 col-md my-2 my-md-0 border rounded-pill p-3 act ">
                        ...
                        <input type="password" namespace="Password" id="confirm" placeholder="Confirm Password" class="text-white" required name="pass2">
                    </div>
                ...
                <div class="row justify-content-center  mb-3">
                    <div class="col-md col-8 my-2 my-md-0 border rounded-pill p-3 act ">
                        ...
                        <input type="email" namespace="email" id="Email" placeholder="Email" class="text-white" required name="email">
                    ...
                    <div class="col-md col-8 my-2 my-md-0 border rounded-pill p-3 act ">
                        ...
                        <input type="phone" namespace="phone" id="phone" placeholder="Phone" class="text-white" required name="phone">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($admin) > 0) {
        echo '<script type="text/javascript">alert("username tersebut tidak boleh digunakan!");</script>';
    } else {
